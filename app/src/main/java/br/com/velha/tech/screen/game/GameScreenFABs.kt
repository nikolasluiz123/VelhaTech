...
internal fun FloatingActionButtonPause(onClick: () -> Unit) {
    FloatingActionButton(
        ...
        Icon(
            ...
            contentDescription = stringResource(br.com.velha.tech.R.string.game_screen_pause_icon_description)
        )
    }
}
...
internal fun FloatingActionButtonPlay(onClick: () -> Unit) {
    FloatingActionButton(
        ...
        Icon(
            ...
            contentDescription = stringResource(br.com.velha.tech.R.string.game_screen_play_icon_description)
        )
    }
}