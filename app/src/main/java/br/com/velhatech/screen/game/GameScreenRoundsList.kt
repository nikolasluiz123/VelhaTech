...
import br.com.velhatech.core.extensions.format
...
private fun getPainterIcon(expanded: Boolean): Painter = if (expanded) {
    painterResource(br.com.velhatech.core.R.drawable.ic_arrow_up_24dp)
} else {
    painterResource(br.com.velhatech.core.R.drawable.ic_arrow_down_24dp)
}
