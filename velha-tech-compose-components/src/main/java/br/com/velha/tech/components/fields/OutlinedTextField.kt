package br.com.velha.tech.components.fields
...
import br.com.velha.tech.components.fields.state.ITextField
import br.com.velha.tech.components.fields.state.TextField
import br.com.velha.tech.compose.components.R
import br.com.velha.tech.core.theme.FieldErrorTextStyle
import br.com.velha.tech.core.theme.InputTextStyle
...
fun OutlinedTextFieldPasswordValidation(
    ...
    OutlinedTextFieldValidation(
        ...
        trailingIcon = {
            ...
            if (passwordVisible) {
                resource = br.com.velha.tech.core.R.drawable.ic_visibility_24dp
                description = stringResource(R.string.description_icon_hide_password)
            } else {
                resource = br.com.velha.tech.core.R.drawable.ic_visibility_off_24dp
